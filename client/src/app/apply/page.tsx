...
import { ApplicationCalendar, ApplicationInput, ApplicationTextarea } from "@/features/application/components/application-input";
    ...
    return (
        <div className="relative w-screen h-screen overflow-x-hidden">
            ...
            <FormCard className="p-4 md:p-16 font-mont">
                ...
                <p className="mt-2 px-4 md:px-20 font-semibold text-muted-foreground text-xs md:text-sm text-center">
