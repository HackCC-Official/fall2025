        ...
        <div className="z-10 relative order-none bg-[#8F43D8] outline-none w-screen">
            ...
            <div className="flex flex-col w-full h-full">
                ...
                <div className="z-50 flex flex-wrap md:flex-nowrap items-around md:gap-10 mx-auto w-[90%] max-w-[1300px] h-[70%] md:h-[70%]">
                    <div className="flex flex-col justify-center items-center bg-glass backdrop-blur-md mx-auto my-auto mb-5 md:mb-0 rounded-[20px] w-[90%] md:w-[50%] h-[375px] lg:h-[425px] text-center">
