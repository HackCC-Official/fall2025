...
export default function VolunteerJudgeContainer() {
    return (
        ...
        <div className="z-10 relative order-none bg-[#8F43D8] outline-none w-screen ">
            ...
            <div className="-bottom-[40px] z-20 relative bg-gradient-to-t from-[#9947DC] to-[#8F43D8] outline-none w-screen h-auto"></div>
            <div className="flex flex-col w-full h-full">
                <div className="flex z-50 mx-auto mt-[50px] w-[90%] max-w-[1300px]">
                ...
                <div className="flex z-50 flex-wrap md:flex-nowrap items-around md:gap-10 mx-auto w-[90%] max-w-[1300px] h-[70%] md:h-[70%]">
                    <div className="flex flex-col justify-center items-center bg-glass backdrop-blur-md mx-auto my-auto rounded-[20px] w-[90%] md:w-[50%] h-[375px] lg:h-[425px] text-center md:mb-0 mb-5">
