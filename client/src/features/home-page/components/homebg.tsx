...
export const Homebg = () => {
    return (
        <div className='z-10'>
            ...
            <Sky></Sky>
            <Image priority loading='eager'src={CatCloud} className="-right-[300px] md:-right-[600px] 2xl:-right-[750px] -bottom-8 md:-bottom-32 2xl:-bottom-20 absolute w-[700px] md:w-[1500px] 2xl:w-[2000px] min-w-[700px] md:min-w-[1500px] 2xl:min-w-[2000px] h-auto animate-swaying ease-linear" alt="Cat Cloud Cluster" sizes="(min-width: 1540px) 2000px, (min-width: 780px) 1500px, 700px" ></Image>
