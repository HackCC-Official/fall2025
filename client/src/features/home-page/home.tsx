        ...
        <FrontPagePrimaryLayout className="flex bg-bgpurple overflow-x-clip text-white">
            <div className="flex flex-col justify-center items-center mx-auto">
                ...
                <div className="z-10 flex flex-col mt-4 mb-8 text-center">
                    <p className="font-bagel text-2xl sm:text-3xl md:text-4xl">November 8th, 2025 </p> 
                    <p className="mt-2 font- font-mont text-base sm:text-lg md:text-xl text-right">Oceanside, California</p>
                </div>
                {/* <Interest></Interest> */}
