        ...
        <div className="flex">
            ...
            <div className="flex flex-col justify-center items-center w-screen h-screen z-50">
                <div className="relative">
                    ...
                    <Image className="lg:h-48 md:h-44 sm:h-40 h-36 w-auto absolute lg:-right-3/4 sm:-right-1/2 -right-1/3 bottom-3/4 animate-bobbing ease-linear" src={helicat} alt="HeliCat"></Image>
                </div>
