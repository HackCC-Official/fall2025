 ...
 export default function Plane() {
     return (
         <div className="flex-shrink-0 w-[300px] lg:w-[400px] h-auto">
             ...
             <Image src={ropeimg} alt="rope" className="invisible md:visible md:bottom-[90px] lg:bottom-[140px] md:left-[110px] lg:left-[210px] -z-10 absolute w-[250px] h-auto"></Image>
         </div>
     )
 }
