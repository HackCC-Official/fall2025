...
export default function Collage() {
    return <div className="-z-30 flex flex-row justify-center items-center bg-gradient-to-b from-richpurple via-richpurple to-hoverpurple w-full h-aut overflow-x-clip">
