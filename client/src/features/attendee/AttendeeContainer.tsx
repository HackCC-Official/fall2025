...
export default function AttendeeContainer() {
    return(
        ...
        <div className="relative bg-gradient-to-t from-bgpurple to-richpurple py-20 lg:py-60 w-full h-auto overflow-x-clip pointer-events-none">
            ...
            <Image src={pinkcloud3} className="-right-10 -bottom-[60px] md:-bottom-[75px] 2xl:-bottom-[115px] z-40 absolute w-[200px] sm:w-[250px] md:w-[300px] 2xl:w-[450px] h-auto pointer-events-none" alt="cloud"></Image>
            <div className="relative mx-auto w-full text-center">
                <Title text="What past attendees have said"></Title>
                <div className="flex md:flex-row flex-col justify-center items-center bg-red-400 text-left">
