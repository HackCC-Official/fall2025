...
export default function AttendeeContainer() {
    return(
        ...
        <div className="relative bg-gradient-to-t from-bgpurple to-richpurple py-20 lg:py-60 w-full h-auto">
            <Image src={cloud} className="top-[150px] md:top-[0px] -left-[50px] z-0 absolute w-[200px] sm:w-[300px] md:w-[500px] 2xl:w-[1000px] h-auto animate-swaying ease-linear" alt="cloud " />
            <Image src={cloud2} className="top-[200px] md:top-[100px] right-0 z-0 absolute w-[200px] sm:w-[300px] md:w-[500px] 2xl:w-[1000px] h-auto animate-swaying ease-linear" alt="cloud" />
