            ...
            <div className='relative bg-bgpurple -mt-[2px] w-screen h-auto overflow-x-clip text-center'>
                ...
                <div className='relative mx-auto pb-10 max-w-[1350px] embla'>
                    ...
                    <div className='flex justify-around items-center mx-auto mt-4 lg:mt-8 w-48 h-auto lg:h-15'>
                        ...
                        <button className="flex justify-center items-center bg-hoverpurple active:bg-black active:shadow-lg rounded-[100%] w-[50px] lg:w-[60px] h-[50px] lg:h-[60px] transition-all active:translate-y-1 duration-150" onClick={scrollNext}>
                            <Image className="w-6 lg:w-9 h-auto" src={right} alt="right-button"></Image> 
                        </button>
                    </div>
                </div>
                </div>
