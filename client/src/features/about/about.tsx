...
export default function About () {
    return (
        <div className='bg-gradient-to-b from-bgpurple to-richpurple w-full h-auto -mt-[5px] -z-20' id='aboutTab'>
            <div className='max-w-[90%] w-[1000px] mx-auto py-20 flex flex-col justify-center align-center items-center text-white'>
                ...
                <div className='font-mont sm:text-center text-base sm:text-lg md:text-2xl 2xl:text-3xl px-8'>
                ...
                <div className='flex sm:flex-row justify-between flex-col'>
                    ...
                    <h1 className='z-10 text-sm sm:text-lg md:text-xl font-medium'>Event Features</h1>
