...
export default function About () {
    return (
        <div className='-z-20 relative bg-gradient-to-b from-bgpurple to-richpurple -mt-[5px] w-full h-auto overflow-x-clip' id='aboutTab'>
            <Image src={texture} className='-top-20 sm:-top-80 left-0 z-0 absolute min-w-[800px] sm:min-w-[1500px] max-w-[800px] sm:max-w-[2000px] h-auto' alt="bg"></Image>
            <Image src={cloudL} className='top-16 sm:top-0 md:-top-16 -left-5 absolute w-[90px] sm:w-48 md:w-72 2xl:w-96 h-auto animate-swaying ease-linear' alt="cloud"></Image>
            <Image src={cloudR} className='top-20 sm:top-10 md:top-2 -right-5 absolute w-28 sm:w-72 md:w-96 2xl:w-96 h-auto animate-swaying ease-linear' alt='cloud'></Image>
