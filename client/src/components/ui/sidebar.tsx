  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex flex-col bg-sidebar w-[--sidebar-tablet] lg:w-[--sidebar-width] h-full text-sidebar-foreground",
            className
          )}
          ref={ref}
          {...props}
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative bg-transparent w-[--sidebar-width-tablet] lg:w-[--sidebar-width] h-svh transition-[width] duration-200 ease-linear",
        ...
        <div
          className={cn(
            "hidden z-10 fixed inset-y-0 md:flex w-[--sidebar-width-tablet] lg:w-[--sidebar-width] h-svh transition-[left,right,width] duration-200 ease-linear",
            side === "left"
